...
<a href="/koperasi/printpdf" target="_blank" class="btn btn-primary">Print To PDF</a>
<h1>DATA PELANGGAN KOPERASI</h1>
<!DOCTYPE html>
<html>
<head>
 <meta charset="utf-8">
 <meta http-equiv="X-UA-Compatible" content="IE=edge">
 <title>KoperasiLTE | Koperasi</title>
 ...
 <!-- title row -->
  ...
  <div class="col-xs-12">
    <h2 class="page-header">
     <i class="fa fa-globe"></i> Laporan Pelanggan Koperasi
